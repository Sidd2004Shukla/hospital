...
# 2. Override the sqlalchemy.url from alembic.ini with the one from .env
...
# 3. Add your model's MetaData object here for 'autogenerate' support
...
# otherwise replace it with your Base.metadata as shown above.
# Tell Alembic to use your Base's metadata
target_metadata = Base.metadata
